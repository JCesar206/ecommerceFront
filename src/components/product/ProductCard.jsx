		...
		<article className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition">
			...
			<div className="p-4">
				...
				<p className="text-gray-500 text-sm mt-2">{product.description}</p>
					...
					<button className="mt-5 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg flex justify-center items-center gap-2 transition cursor-pointer">
						<MdOutlineShoppingCart size={18}/>Agregar
					</button>
			</div>
		</article>
	);
