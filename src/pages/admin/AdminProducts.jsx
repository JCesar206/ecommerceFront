...
console.log("ESTOY EN ADMIN PRODUCTS", products);
	...
	return (
		<div className="max-w-7xl mx-auto py-10 px-4">
			<div className="flex justify-between items-center mb-8">
				...
				<button onClick={handleCreate} className="bg-green-600 hover:bg-green-800 text-white font-semibold px-5 py-2 rounded cursor-pointer">Producto nuevo</button>
			</div>
				...
				{products.map(product => (
					<div key={product.id} className="border rounded-lg p-5 shadow">
						...
						<div className="flex flex-col gap-3 mt-5">
							<button onClick={() => handleEdit(product)} className="bg-blue-600 hover:bg-blue-800 text-white font-semibold px-4 py-2 rounded cursor-pointer">Editar</button>
